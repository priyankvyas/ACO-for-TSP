...
Usage: java problem \<filename\> \<numberOfColonies\>  
Here \<filename\> would be one of the *.tsp.txt files provided in the repository and \<numberOfColonies\> is the number of 5 ant sub-colonies for the coarse-grained parallelised ant colony.  
Initially a 2-D scatter plot will be displaying the cities in the dataset.
When the mouse is hovered over the points, the cities' index will be displayed.  
