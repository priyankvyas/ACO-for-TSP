...
///Parallel Coarse-grained version of the Ant Colony Optimization algorithm for the symmetric travelling salesperson problem
class problem {
    ...
    static int numColony = 0;
    //Contains the sub-colony threads
    static ArrayList<ColonyThread> colonyThreads = new ArrayList<>();
    //Number of ants in each sub-colony
    ...
    public static void main(String[] args){
        //Parse in the filename and number of colonies
        if(args.length != 2){
            System.err.println("Usage: java problem <filename> <numColonies>");
        }
        //Read the problem set file
        String file = args[0];
        numColony = Integer.parseInt(args[1]);
        readFile(file);
